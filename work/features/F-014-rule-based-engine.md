...
- Implement Mariáš-specific `possibleActions` logic.
- Update Server API to include `possibleActions` in game responses.
- Decouple `GameState` from Mariáš-specific fields.

## Tasks
- [ ] T-043: Define RuleSet interface and Registry
- [ ] T-044: Implement possibleActions for Mariáš trick-taking
